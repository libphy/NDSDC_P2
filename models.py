...
def cascadeVGG(x, keep_prob):
    ...
    # Pooling.
    conv2m = tf.nn.max_pool(conv2, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='VALID')
    # Dropout
    ...
    # Pooling.
    conv4m = tf.nn.max_pool(conv4, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='VALID')
    # Dropout
    ...
    conv6 = tf.nn.relu(conv6)
    # Pooling.
    conv6m = tf.nn.max_pool(conv6, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='VALID')
    # Dropout
